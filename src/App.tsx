...
const JudgesSlider = () => {
  ...
  const judges = [
    { name: "levelsio", twitter: "@levelsio", image: "/public/levelsio.jpg" },
    { name: "Logan Kilpatrick", twitter: "@OfficialLoganK", image: "/public/loganK.jpg" },
    { name: "sarah guo // conviction", twitter: "@saranormous", image: "/public/saranormous.jpg" },
    { name: "Theo - t3.gg", twitter: "@theo", image: "/public/theo.jpg" },
    { name: "Evan You", twitter: "@youyuxi", image: "/public/youyuxi.jpg" },
    { name: "KP", twitter: "@thisiskp_", image: "/public/thisiskp_.jpg" },
  ];
...
const SponsorsSlider = () => {
  ...
  const sponsors = [
    { id: 1, name: "Supabase", logo: "/public/supabase.jpg" },
    { id: 2, name: "Netlify", logo: "/public/Netlify.png" },
    { id: 3, name: "CloudflareDev", logo: "/public/CloudflareDev.jpg" },
    { id: 4, name: "Sentry", logo: "/public/getsentry.png" },
    { id: 5, name: "Loops", logo: "/public/loops.jpg" },
    { id: 6, name: "AlgoFoundation", logo: "/public/AlgoFoundation.jpg" },
  ];
