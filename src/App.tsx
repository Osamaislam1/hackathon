...
const JudgesSlider = () => {
  ...
  const judges = [
    { name: "levelsio", twitter: "@levelsio", image: "assets/images/levelsio.jpg" },
    { name: "Logan Kilpatrick", twitter: "@OfficialLoganK", image: "assets/images/loganK.jpg" },
    { name: "sarah guo // conviction", twitter: "@saranormous", image: "assets/images/saranormous.jpg" },
    { name: "Theo - t3.gg", twitter: "@theo", image: "assets/images/theo.jpg" },
    { name: "Evan You", twitter: "@youyuxi", image: "assets/images/youyuxi.jpg" },
