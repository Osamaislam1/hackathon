  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-gradient-to-r from-purple-700 via-cyan-600 to-blue-500 bg-opacity-90 backdrop-blur-lg border-b border-gray-800">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="text-white text-2xl font-extrabold">Hackathon.dev</div>
...
/* ==============================
   ...
   ============================== */
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black pt-16 overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4">
      ...
      <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-xl mx-auto">
        Join thousands of developers worldwide in this groundbreaking event
        where innovation meets opportunity. Build the next big thing and compete
        for life-changing prizes. This virtual hackathon will take place on a
        date to be determined, with over $1 million in prizes across multiple
        categories.
      </p>
  ...
  const judges = [
    {
      name: "levelsio",
      twitter: "@levelsio",
      image: "assets/images/levelsio.jpg",
    },
    {
      name: "Logan Kilpatrick",
      twitter: "@OfficialLoganK",
      image: "assets/images/loganK.jpg",
    },
    {
      name: "sarah guo // conviction",
      twitter: "@saranormous",
      image: "assets/images/saranormous.jpg",
    },
    { name: "Theo - t3.gg", twitter: "@theo", image: "assets/images/theo.jpg" },
    {
      name: "Evan You",
      twitter: "@youyuxi",
      image: "assets/images/youyuxi.jpg",
    },
    { name: "KP", twitter: "@thisiskp_", image: "assets/images/thisiskp_.jpg" },
  ];
    ...
    <div className="overflow-hidden cursor-grab">
      ...
      >
        {judges.map((judge, index) => (
          <motion.div
            key={index}
            className="min-w-[250px] card glow-card p-4 text-center"
          >
            <img
              src={judge.image}
              alt={judge.name}
...
const SponsorsSlider = () => {
  ...
  const sponsors = [
    { id: 1, name: "Supabase", logo: "assets/images/supabase.jpg" },
    { id: 2, name: "Netlify", logo: "assets/images/Netlify.png" },
    { id: 3, name: "CloudflareDev", logo: "assets/images/CloudflareDev.jpg" },
    { id: 4, name: "Sentry", logo: "assets/images/getsentry.png" },
    { id: 5, name: "Loops", logo: "assets/images/loops.jpg" },
    { id: 6, name: "AlgoFoundation", logo: "assets/images/AlgoFoundation.jpg" },
  ];
    ...
    <div className="overflow-hidden cursor-grab">
      ...
      >
        {sponsors.map((sponsor) => (
          <motion.div
            key={sponsor.id}
            className="min-w-[200px] card glow-card p-4 flex items-center justify-center"
          >
            <img
              src={sponsor.logo}
              alt={sponsor.name}
        ...
        <section id="sponsors" className="py-20 bg-gray-900/50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-gray-400 mb-8 max-w-2xl mx-auto">
              Special thanks to our generous sponsors who make this event
              possible.
            </p>
            <SponsorsSlider />
          </div>
      ...
      <section id="contact" className="py-20 bg-gray-900/50 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-xl mx-auto">
            <form className="space-y-6 card glow-card p-8 relative">
              {/* Adding a higher z-index to form elements */}
              ...
              <button
                type="submit"
                className="bg-cyan-500 px-6 py-3 rounded text-white font-semibold hover:bg-cyan-600 transition w-full relative z-10"
              >
                Send
              </button>
            </form>
